...
cover:
    ...
    alt: "William Brander" # alt text
    caption: "William Brander explaining like a pro" # display caption under cover
...
### **How building a portable escape room made me a better developer** by William Brander
...
### **Creating an observable cloud platform and application landscape with Azure** by Alex Thissen
...
### **Delivering on Identity Solutions - practical guidance and pitfalls to avoid** by Michele Leroux Bustamante
...
### **What's new in C# 13, 14, and beyond?** by Bart de Smet
...
### **Kafka for .NET Developers** by Ian Cooper
...
### **Scaling Azure Container Apps: maximize performance and minimize costs** by Anthony Chu
**Session abstract:** *"Azure Container Apps is a fully managed serverless container platform that allows you to run containerized workloads at scale. By using the correct scaling strategies and pricing plans, you can maximize performance and minimize costs of your Azure Container Apps workloads. In this session, we'll show you how to scale container apps and jobs on Azure Container Apps using its built-in KEDA scalers. Whether you're running a small app or a large-scale microservice application, we'll show you how to build and scale your containerized workloads on Azure Container Apps to maximize performance and minimize costs."*
   - Key takeaways:
     ...
     - On top of KEDA Azure Container Apps can scale based on HTTP request.

### **Debugging Like a Coach: Fixing Team Bugs Before They Crash the Game** by Amber Vanderburg
...
### **All-Time Sportiest Hacks** by Eric de Maar
...
I wanted to go to the influencing session but it was a "Stairs session", as in a full room. Thats why i decided to explore some stands instead.
